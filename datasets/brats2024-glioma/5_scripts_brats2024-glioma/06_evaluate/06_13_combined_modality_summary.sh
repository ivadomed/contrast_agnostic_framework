#!/usr/bin/env bash
# Cross-training-modality aggregation (t1n + t2w pooled) with an inline
...
#
# Usage:
#   bash 06_13_combined_modality_summary.sh <config.yaml>
#   bash 06_13_combined_modality_summary.sh configs/brats_combined_01_results.yaml
set -euo pipefail

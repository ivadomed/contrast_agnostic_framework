...
# Auglab wrappers override this to 01_predictions/auglab before sourcing env.sh.
export nnUNet_results="${DATASET_ROOT}/8_results_brats2024-glioma/01_predictions/nnUNet"
export SPLITS_DIR="${DATASET_ROOT}/4_splits_brats2024-glioma"
# Prediction output root: 01_predictions/{category}/{run_id}/fold{k}/{contrast}/

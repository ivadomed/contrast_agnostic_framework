...
shared base (src/nnunet/trainers/v26_6_base.py):

  * synthesis variant      → nnUNetTrainerV26_6._synthesize (whole-image K-means)
...
from src.nnunet.trainers.v26_6_base import nnUNetTrainerV26_6, _build_synth_training_transforms

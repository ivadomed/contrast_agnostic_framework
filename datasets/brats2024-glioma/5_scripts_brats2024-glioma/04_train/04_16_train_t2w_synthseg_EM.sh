#!/usr/bin/env bash
# Train SynthSeg+EM GPU augmentation on BraTS 2024 Glioma T2w.
# AugLab standard augs are deactivated (prob=0 in this config); only SynthSeg+EM synthesis.
# 4 folds, 1 GPU per fold, 2500 epochs.
#
# Usage:
#   bash 04_16_train_t2w_synthseg_EM.sh           # auto RUN_ID
#   bash 04_16_train_t2w_synthseg_EM.sh brats2024-glioma_t2w_synthseg_EM_<TS>  # resume
...
DATASET_ID="052"
DA_WORKERS=0
LOG_DIR="/tmp/nnunet_brats2024_t2w_synthseg_EM"

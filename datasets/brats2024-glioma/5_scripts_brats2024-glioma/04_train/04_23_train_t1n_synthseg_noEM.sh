#!/usr/bin/env bash
# Train SynthSeg (no EM) GPU augmentation on BraTS 2024 Glioma T1n.
# AugLab standard augs are deactivated (prob=0 in this config); only SynthSeg without EM.
# 4 folds, 1 GPU per fold, 2500 epochs.
#
# Usage:
#   bash 04_23_train_t1n_synthseg_noEM.sh           # auto RUN_ID
#   bash 04_23_train_t1n_synthseg_noEM.sh brats2024-glioma_t1n_synthseg_noEM_<TS>  # resume
...
DATASET_ID="051"
DA_WORKERS=0
LOG_DIR="/tmp/nnunet_brats2024_t1n_synthseg_noEM"

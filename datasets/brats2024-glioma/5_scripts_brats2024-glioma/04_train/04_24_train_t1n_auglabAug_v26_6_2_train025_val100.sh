#!/usr/bin/env bash
# AugLab augs + V26_6_2 GPU synthesis on BraTS 2024 Glioma T1n: 25% train synth / 100% val synth.
...
#
# Usage:
#   bash 04_24_train_t1n_auglabAug_v26_6_2_train025_val100.sh           # auto RUN_ID
#   bash 04_24_train_t1n_auglabAug_v26_6_2_train025_val100.sh brats2024-glioma_t1n_auglabAug_v26_6_2_train025_val100_<TS>  # resume
...
DATASET_ID="051"
DA_WORKERS=0
LOG_DIR="/tmp/nnunet_brats2024_t1n_auglabAug_v26_6_2_train025_val100"

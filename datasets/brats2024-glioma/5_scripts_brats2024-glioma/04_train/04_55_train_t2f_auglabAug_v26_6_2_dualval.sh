#!/usr/bin/env bash
# OUR METHOD, DUAL VALIDATION on BraTS 2024 Glioma T2f/FLAIR: ONE training run that
...
#
# Uses nnUNetTrainerBraTS2024GliomaT2fAugLabDualVal (see
...
# TRAINER=nnUNetTrainerBraTS2024GliomaT2fAugLabDualVal (both mirrors live under
# this trainer's directory name — NOT AugLabDefault/AugLabValSynth).
#
# 3 folds (0 1 2), 1 GPU per fold, 2500 epochs.
#
# Usage:
#   bash 04_55_train_t2f_auglabAug_v26_6_2_dualval.sh           # auto RUN_ID (…_val000_<TS>)
#   bash 04_55_train_t2f_auglabAug_v26_6_2_dualval.sh brats2024-glioma_t2f_auglabAug_v26_6_2_train050_val000_<TS>  # resume
...
DATASET_ID="053"
DA_WORKERS=0
LOG_DIR="/tmp/nnunet_brats2024_t2f_auglabAug_v26_6_2_train050_dualval"

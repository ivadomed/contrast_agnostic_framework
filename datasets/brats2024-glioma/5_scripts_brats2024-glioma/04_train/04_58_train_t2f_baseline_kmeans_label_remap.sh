#!/usr/bin/env bash
# BASELINE-ANCHORED CAUSAL LADDER (BraTS T2f/FLAIR), rung 3 -- K-means clustering +
...
# used by T1n's/T2w's equivalent rung.
#
# Usage: bash 04_58_train_t2f_baseline_kmeans_label_remap.sh [RUN_ID]
...
DATASET_ID="053"
DA_WORKERS=8
LOG_DIR="/tmp/nnunet_brats2024_t2f_baseline_kmeans_label_remap"

#!/usr/bin/env bash
# Train SynthSeg+EM GPU augmentation on BraTS 2024 Glioma T2f/FLAIR.
...
#
# Usage:
#   bash 04_52_train_t2f_synthseg_EM.sh           # auto RUN_ID
#   bash 04_52_train_t2f_synthseg_EM.sh brats2024-glioma_t2f_synthseg_EM_<TS>  # resume
...
DATASET_ID="053"
DA_WORKERS=0
LOG_DIR="/tmp/nnunet_brats2024_t2f_synthseg_EM"

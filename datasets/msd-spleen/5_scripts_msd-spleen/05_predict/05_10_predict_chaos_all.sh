#!/usr/bin/env bash
# Run ALL chaos T1in-trained models over MSD-SPLEEN CT, folds 0 1 2 each (project fold
# policy — see CLAUDE.md). Methods run SEQUENTIALLY (each method fans its folds across
# the GPUs/slots and waits) so we never oversubscribe. MSD-SPLEEN has no models of its
# own — every model here is chaos-trained (cross-dataset). See 05_01_predict_common.sh.
#
...
echo "=================================================================="
echo " MSD-SPLEEN <- CHAOS T1in models | all 8 runs x folds 0-2 x CT"
echo "=================================================================="

#!/usr/bin/env bash
# Predict on MSD-SPLEEN CT with the CHAOS-TRAINED v26_6_2 model (train050_val100, plain
# nnUNet trainer — "v26_6_2 alone", distinct from the AugLab-wrapped OURS method below).

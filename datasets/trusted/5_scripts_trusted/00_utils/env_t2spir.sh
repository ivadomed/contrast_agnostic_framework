...
# Source this instead of env.sh when predicting/evaluating with chaos T2spir-trained
# models. Usage: source env_t2spir.sh  (from a wrapper that pre-exports CHAOS_* vars)
#

#!/usr/bin/env bash
# Train SRCSM (SemRandConv-3D, Thaler et al. 2025) on picai-prostate T2W (Dataset080_PICAI_T2W).
# csPCa lesion segmentation; 3 folds (0 1 2), 1 GPU/fold, 2000 epochs.
#
# Usage:
#   bash 04_05_train_t2w_srcsm.sh                                  # auto RUN_ID
#   bash 04_05_train_t2w_srcsm.sh picai-prostate_t2w_srcsm_<TS>   # resume

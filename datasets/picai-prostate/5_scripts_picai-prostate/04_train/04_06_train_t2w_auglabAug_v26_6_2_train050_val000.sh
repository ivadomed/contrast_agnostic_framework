#!/usr/bin/env bash
# Train OUR METHOD (AugLab default augs + V26_6_2 GPU contrast synthesis @50% train), DUAL VALIDATION on picai-prostate T2W (Dataset080_PICAI_T2W).
...
#
# Usage:
#   bash 04_06_train_t2w_auglabAug_v26_6_2_train050_val000.sh                                  # auto RUN_ID
#   bash 04_06_train_t2w_auglabAug_v26_6_2_train050_val000.sh picai-prostate_t2w_auglabAug_v26_6_2_train050_val000_<TS>   # resume

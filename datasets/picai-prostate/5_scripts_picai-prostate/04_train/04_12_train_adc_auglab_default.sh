#!/usr/bin/env bash
# Train AUGLAB_DEFAULT (AugLab's stock GPU augmentation suite, no contrast synthesis) on picai-prostate ADC (Dataset081_PICAI_ADC).
# csPCa lesion segmentation; 3 folds (0 1 2), 1 GPU/fold, 2000 epochs.
#
# Usage:
#   bash 04_12_train_adc_auglab_default.sh                                  # auto RUN_ID
#   bash 04_12_train_adc_auglab_default.sh picai-prostate_adc_auglab_default_<TS>   # resume

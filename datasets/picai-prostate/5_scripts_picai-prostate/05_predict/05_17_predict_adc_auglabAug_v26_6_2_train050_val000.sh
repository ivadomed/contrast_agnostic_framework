#!/usr/bin/env bash
# Predict with OUR METHOD, clean/val000 checkpoint (ADC-trained) on the picai-prostate
...
# Usage: bash $(basename 05_predict/05_17_predict_adc_auglabAug_v26_6_2_train050_val000.sh) <RUN_ID> [FOLD] [ITEM ...]
set -euo pipefail

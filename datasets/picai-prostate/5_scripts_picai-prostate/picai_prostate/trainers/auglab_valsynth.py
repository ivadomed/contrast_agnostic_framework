"""
nnUNetTrainerPICAIProstateAugLabValSynth — AugLab trainer with synthesis-only validation.
...
class nnUNetTrainerPICAIProstateAugLabValSynth(nnUNetTrainerPICAIProstateAugLabDefault):
    """AugLab for picai-prostate with synth-only validation (val metrics on synthesised images)."""

...
# train, 0% val synth (clean validation) — same ImageContrastV26_6_2GPUTransform
# class as 04_26 (v26_6_2 alone headline, the REAL (mu, alpha) affine remap),
# NOT the NoiseFill-ablation class used by 04_24/04_25 (label_remap/voronoi
# rungs) — just skip_sub_parc_prob=1.0 instead of 04_26's 0.4, i.e. Voronoi
# sub-parcellation turned off. Isolates Voronoi's contribution on the REAL
# mechanism. Companion to 04_34 (val100 variant). Extra arm — not a
...
#
# Usage:
#   bash 04_33_train_baseline_kmeans_label_remap_affine_remap_train050_val000.sh

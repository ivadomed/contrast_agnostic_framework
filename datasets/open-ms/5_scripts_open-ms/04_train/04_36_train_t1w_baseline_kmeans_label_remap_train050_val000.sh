#!/usr/bin/env bash
# BASELINE-ANCHORED CAUSAL LADDER (open-ms T1w), rung 3 -- + label remap on top
# of K-means clustering, @50% train, 0% val synth (clean validation). Mirrors
# 04_24 (the FLAIR sibling) exactly, just on T1w. 3 folds (0,1,2), 1 GPU/fold,
# 2000 epochs. nnUNet-category.
#
# Usage:
#   bash 04_36_train_t1w_baseline_kmeans_label_remap_train050_val000.sh
...
DATASET_ID="071"
DA_WORKERS=8
LOG_DIR="${RESULTS_DIR}/_logs/nnunet_open-ms_t1w_baseline_kmeans_label_remap_train050_val000"

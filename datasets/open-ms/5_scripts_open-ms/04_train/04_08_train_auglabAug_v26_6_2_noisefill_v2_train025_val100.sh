...
# (PALETTE) and, if run, 04_09 (v2 + no Voronoi).
# 3 folds (0,1,2 — see TRAIN_FOLDS below), 1 GPU/fold, 2000 epochs. AugLabValSynth trainer.
#
# Usage:
#   bash 04_08_train_auglabAug_v26_6_2_noisefill_v2_train025_val100.sh
...
DATASET_ID="070"
DA_WORKERS=8
LOG_DIR="${RESULTS_DIR}/_logs/nnunet_open-ms_auglabAug_v26_6_2_noisefill_v2_train025_val100"
...
export AUGLAB_PARAMS_GPU_JSON="${AUGLAB_CONFIGS_DIR}/transform_params_gpu_default01-23_auglabAug_ImageContrastV26_6_2NoiseFillV2GPUTransform_train025.json"

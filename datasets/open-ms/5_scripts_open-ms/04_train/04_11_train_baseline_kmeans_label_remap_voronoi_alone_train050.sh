...
#
# Usage:
#   bash 04_11_train_baseline_kmeans_label_remap_voronoi_alone_train050.sh
...
DATASET_ID="070"
DA_WORKERS=8
LOG_DIR="${RESULTS_DIR}/_logs/nnunet_open-ms_baseline_kmeans_label_remap_voronoi_train050_val100"

...
# 3 folds (0 1 2), 1 GPU/fold, 2000 epochs, 30h.
#
# Usage:
#   bash 04_18_train_t1w_auglabAug_v26_6_2_train025_val100.sh                                        # auto RUN_ID
#   bash 04_18_train_t1w_auglabAug_v26_6_2_train025_val100.sh open-ms_t1w_auglabAug_v26_6_2_train025_val100_<TS>  # resume
...
DATASET_ID="071"
DA_WORKERS=8
LOG_DIR="${RESULTS_DIR}/_logs/nnunet_open-ms_t1w_auglabAug_v26_6_2_train025_val100"

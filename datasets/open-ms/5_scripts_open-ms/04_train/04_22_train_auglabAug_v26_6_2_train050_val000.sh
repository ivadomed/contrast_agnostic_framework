...
# 0% val synth, on open-ms FLAIR. AugLabDefault trainer (clean validation).
# 3 folds, 1 GPU/fold, 2000 epochs.
#
# Usage:
#   bash 04_22_train_auglabAug_v26_6_2_train050_val000.sh                                        # auto RUN_ID
#   bash 04_22_train_auglabAug_v26_6_2_train050_val000.sh open-ms_auglabAug_v26_6_2_train050_val000_<TS>  # resume
...
DATASET_ID="070"
DA_WORKERS=8
LOG_DIR="${RESULTS_DIR}/_logs/nnunet_open-ms_auglabAug_v26_6_2_train050_val000"

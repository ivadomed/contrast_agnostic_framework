...
# intensity suite) on open-ms T1w @50% train, 100% val synth. nnUNet-category model
# (the "Ours, v26 only" row in the 6-method suite). Same trainer class as auglabAug_v26,
# but the v26-only spatialDA config. 3 folds (0 1 2), 1 GPU/fold, 2000 epochs, 30h.
#
# Usage:
#   bash 04_17_train_t1w_v26_6_2_train050_val100.sh                                        # auto RUN_ID
#   bash 04_17_train_t1w_v26_6_2_train050_val100.sh open-ms_t1w_v26_6_2_train050_val100_<TS>  # resume
...
DATASET_ID="071"
DA_WORKERS=8
LOG_DIR="${RESULTS_DIR}/_logs/nnunet_open-ms_t1w_v26_6_2_train050_val100"

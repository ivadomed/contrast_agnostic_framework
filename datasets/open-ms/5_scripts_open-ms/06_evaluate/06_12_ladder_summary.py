...
def _rungs_auglab():
    return [
        ...
        ("no_voronoi", "+ K-means intensity clustering",
         "auglab_open-ms_flair_auglabAug_v26_6_2_noisefill_v2_no_voronoi_train025_val100_20260707_065414"),
        ("noisefill-v2", "+ Voronoi spatial sub-parcellation",
         "auglab_open-ms_flair_auglabAug_v26_6_2_noisefill_v2_train025_val100_20260707_065409"),
...
def _rungs_baseline():
    return [
        ...
        ("K-means+noise, alone", "+ K-means intensity clustering (SynthSeg-EM analog)",
         _resolve("nnUNet_open-ms_flair_v26_6_2_noisefill_v2_no_voronoi_train050_val100_")),
        ("+Voronoi, alone", "+ Voronoi spatial sub-parcellation",
         _resolve("nnUNet_open-ms_flair_v26_6_2_noisefill_v2_train050_val100_")),

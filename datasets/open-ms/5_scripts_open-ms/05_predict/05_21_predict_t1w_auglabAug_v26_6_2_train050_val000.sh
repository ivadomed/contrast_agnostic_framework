#!/usr/bin/env bash
# Predict with OUR METHOD (auglabAug_v26_6_2_train050_val000) on open-ms T1w across all
# test contrasts (FLAIR/T2W/T1W, folds 0 1 2).
# Usage: bash 05_21_predict_t1w_auglabAug_v26_6_2_train050_val000.sh <RUN_ID> [FOLD] [CONTRAST ...]
set -euo pipefail

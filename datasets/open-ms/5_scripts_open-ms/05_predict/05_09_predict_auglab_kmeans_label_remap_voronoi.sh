#!/usr/bin/env bash
# Predict with the LEVEL-3 CAUSAL ABLATION v2 (auglab_kmeans_label_remap_voronoi_train025_val100)
...
# Usage: bash 05_09_predict_auglab_kmeans_label_remap_voronoi.sh <RUN_ID> [FOLD] [ITEM ...]
set -euo pipefail

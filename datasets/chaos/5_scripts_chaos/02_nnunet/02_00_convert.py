#!/usr/bin/env python3
"""
Convert CHAOS BIDS → nnUNet raw format — MR T1-DUAL in-phase only.

Produces Dataset060_CHAOS_MR_T1in: single channel (T1 in-phase), 4 organ labels.
Only the MR cross-validation cases go into imagesTr — the held-out MR internal-test
...
def main() -> None:
    ...
    # MR CV cases = all MR subjects minus internal-test holdout.

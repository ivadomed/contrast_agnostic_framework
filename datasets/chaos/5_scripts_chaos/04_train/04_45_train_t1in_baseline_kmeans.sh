...
# skip_sub_parc_prob=1.0). Same shared AugLab config already used by open-ms's
# equivalent rung (dataset-agnostic — label_classes auto-detected).
#
...
# (datasets/chaos/5_scripts_chaos/chaos/trainers/auglab_dualval.py).
#

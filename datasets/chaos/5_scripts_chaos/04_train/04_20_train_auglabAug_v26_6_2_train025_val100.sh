#!/usr/bin/env bash
# AugLab default augs + V26_6_2 GPU transform @25% train, 100% val synth.
...
#
# Usage:
#   bash 04_20_train_auglabAug_v26_6_2_train025_val100.sh                                      # auto: chaos_auglabAug_v26_6_2_train025_val100_<TS>
#   bash 04_20_train_auglabAug_v26_6_2_train025_val100.sh chaos_auglabAug_v26_6_2_train025_val100_<TS>  # resume
...
DATASET_ID="060"
DA_WORKERS=0
LOG_DIR="/tmp/nnunet_chaos_auglabAug_v26_6_2_train025_val100"

#!/usr/bin/env bash
# BASELINE-ANCHORED CAUSAL LADDER (T2spir), rung 3 — K-means + per-anatomical-
# label remap + Voronoi spatial sub-parcellation (skip_sub_parc_prob=0.4).
# Same shared AugLab config already used by the T1in ladder's equivalent rung
# (dataset-agnostic).
#
...
#
# Usage:
#   bash 04_57_train_t2spir_baseline_kmeans_label_remap_voronoi.sh
...
LOG_DIR="${PREDICTIONS_ROOT}/${MODEL_TYPE}/${TRAINING_CONTRAST}/_logs/nnunet_chaos_t2spir_baseline_kmeans_label_remap_voronoi_train050_val000"

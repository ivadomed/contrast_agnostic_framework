#!/usr/bin/env bash
# Train AugLab default GPU augmentation on CHAOS MR T1in (standard aug, no synthesis).
# 4 folds, 1 GPU per fold, 2500 epochs.
#
# Usage:
#   bash 04_35_train_t1in_auglab_default.sh                                # auto RUN_ID
#   bash 04_35_train_t1in_auglab_default.sh chaos_t1in_auglab_default_<TS>  # resume
...
LOG_DIR="/tmp/nnunet_chaos_t1in_auglab_default"

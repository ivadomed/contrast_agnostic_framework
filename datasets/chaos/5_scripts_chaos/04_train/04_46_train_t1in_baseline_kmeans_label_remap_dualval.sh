...
#
# Usage:
#   bash 04_46_train_t1in_baseline_kmeans_label_remap_dualval.sh
...
LOG_DIR="${PREDICTIONS_ROOT}/${MODEL_TYPE}/${TRAINING_CONTRAST}/_logs/nnunet_chaos_t1in_baseline_kmeans_label_remap_train050_dualval"

...
#
# Usage:
#   bash 04_51_train_t1in_auglab_kmeans_label_remap_voronoi.sh
source "$(dirname "$0")/../00_utils/env.sh"

METHOD="auglab_kmeans_label_remap_voronoi_train025_val000"
TRAINER="nnUNetTrainerCHAOSAugLabDualVal"
DATASET_ID="060"
DA_WORKERS="${DA_WORKERS:-0}"
LOG_DIR="${PREDICTIONS_ROOT}/${MODEL_TYPE}/${TRAINING_CONTRAST}/_logs/nnunet_chaos_t1in_auglab_kmeans_label_remap_voronoi_train025_val000"

#!/usr/bin/env bash
# AugLab augs + V26_6_2 GPU transform on CHAOS MR T2spir: 25% train synth / 100% val synth.
# Train pipeline: full AugLab augs + V26 synth at prob 0.25.
# Val pipeline:   synth-only, V26 synth at prob 1.0 (VALsynthonly config).
# 4 folds, 1 GPU per fold, 200 epochs.
#
# Usage:
#   bash 04_32_train_t2spir_auglabAug_v26_6_2_train025_val100.sh                                           # auto RUN_ID
#   bash 04_32_train_t2spir_auglabAug_v26_6_2_train025_val100.sh chaos_t2spir_auglabAug_v26_6_2_train025_val100_<TS>  # resume
...
LOG_DIR="/tmp/nnunet_chaos_t2spir_auglabAug_v26_6_2_train025_val100"

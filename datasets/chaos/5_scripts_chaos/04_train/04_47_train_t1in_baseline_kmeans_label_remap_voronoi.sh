...
#
# Usage:
#   bash 04_47_train_t1in_baseline_kmeans_label_remap_voronoi.sh
...
LOG_DIR="${PREDICTIONS_ROOT}/${MODEL_TYPE}/${TRAINING_CONTRAST}/_logs/nnunet_chaos_t1in_baseline_kmeans_label_remap_voronoi_train050_val000"

...
# Voronoi spatial sub-parcellation (skip_sub_parc_prob=0.4). Same shared
# AugLab config already used by open-ms's equivalent rung (dataset-agnostic).
#
...
#
# Usage:
#   bash 04_47_train_t1in_baseline_kmeans_label_remap_voronoi_dualval.sh
...
LOG_DIR="${PREDICTIONS_ROOT}/${MODEL_TYPE}/${TRAINING_CONTRAST}/_logs/nnunet_chaos_t1in_baseline_kmeans_label_remap_voronoi_train050_dualval"

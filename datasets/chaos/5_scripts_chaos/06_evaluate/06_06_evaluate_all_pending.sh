...
bash "${EVAL_DIR}/06_01_evaluate_run.sh" \
    "chaos_v26_6_2_train025_val100_20260616_200514" all &

bash "${EVAL_DIR}/06_01_evaluate_run.sh" \
    "chaos_v26_6_2_train090_val100_20260615_213615" all &

bash "${EVAL_DIR}/06_01_evaluate_run.sh" \
    "chaos_auglabAug_v26_6_2_train025_val100_20260616_200514" all &

bash "${EVAL_DIR}/06_01_evaluate_run.sh" \
    "chaos_auglabAug_v26_6_2_train050_val100_20260616_112420" all &

bash "${EVAL_DIR}/06_01_evaluate_run.sh" \
    "chaos_auglabAug_v26_6_2_train090_val000_20260616_200514" all &

bash "${EVAL_DIR}/06_01_evaluate_run.sh" \
    "chaos_auglabAug_v26_6_2_train090_val100_20260616_200514" all &
...
SLOT=2 bash "${EVAL_DIR}/06_01_evaluate_run.sh" \
    "chaos_v26_6_2_train025_val000_20260616_010628" 2 &
SLOT=3 bash "${EVAL_DIR}/06_01_evaluate_run.sh" \
    "chaos_v26_6_2_train025_val000_20260616_010628" 3 &

# auglabAug_synthseg_EM: had folds 0,1 → now adding 2,3
SLOT=2 bash "${EVAL_DIR}/06_01_evaluate_run.sh" \
    "chaos_auglabAug_synthseg_EM_train100_val000_20260615_213615" 2 &
SLOT=3 bash "${EVAL_DIR}/06_01_evaluate_run.sh" \
    "chaos_auglabAug_synthseg_EM_train100_val000_20260615_213615" 3 &

# auglabAug_025_val000: had folds 0,1 → now adding 2,3
SLOT=2 bash "${EVAL_DIR}/06_01_evaluate_run.sh" \
    "chaos_auglabAug_v26_6_2_train025_val000_20260616_010628" 2 &
SLOT=3 bash "${EVAL_DIR}/06_01_evaluate_run.sh" \
    "chaos_auglabAug_v26_6_2_train025_val000_20260616_010628" 3 &

# auglabAug_050_val000: had fold 0 → now adding 1,2,3
SLOT=1 bash "${EVAL_DIR}/06_01_evaluate_run.sh" \
    "chaos_auglabAug_v26_6_2_train050_val000_20260615_213615" 1 &
SLOT=2 bash "${EVAL_DIR}/06_01_evaluate_run.sh" \
    "chaos_auglabAug_v26_6_2_train050_val000_20260615_213615" 2 &
SLOT=3 bash "${EVAL_DIR}/06_01_evaluate_run.sh" \
    "chaos_auglabAug_v26_6_2_train050_val000_20260615_213615" 3 &

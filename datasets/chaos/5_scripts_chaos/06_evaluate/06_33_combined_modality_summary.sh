#!/usr/bin/env bash
# Cross-training-modality aggregation (T1in + T2spir pooled) with an inline
...
#
# Usage:
#   bash 06_33_combined_modality_summary.sh <config.yaml>
#   bash 06_33_combined_modality_summary.sh configs/chaos_combined_01_results.yaml
set -euo pipefail

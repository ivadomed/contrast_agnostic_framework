...
Usage (original ON-Harmony):
  set_slot 3 .venv/bin/python analysis/contrast_manifold/scripts/extract_features_curia.py \\
...
Usage (synthetic v19_c, 3 parallel processes):
  set_slot 3 .venv/bin/python ... --mode synthetic --gpu-id 1 --rank 0 --world-size 3 ...
  set_slot 3 .venv/bin/python ... --mode synthetic --gpu-id 2 --rank 1 --world-size 3 ...
  set_slot 3 .venv/bin/python ... --mode synthetic --gpu-id 3 --rank 2 --world-size 3 ...
"""

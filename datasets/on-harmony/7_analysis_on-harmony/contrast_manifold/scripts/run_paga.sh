#!/usr/bin/env bash
# PAGA connectivity (real ↔ synthetic) — high-dim kNN graph, null-calibrated.
#
# Usage:
#   bash run_paga.sh <DATA_SUBDIR> <SYNTH_PREFIX> <OUTPUT_DIR> [MASK_TYPE]
# Example (defaults shown):
#   bash run_paga.sh synthetic_v26_6_guidance_lhc synthetic_v26_6_guidance_lhc \
#     outputs/plots/v26/v26_6_guidance_lhc_r1/regional_hist_64/umap/PAGA regional_hist_64
set -euo pipefail

DATA_SUBDIR="${1:-synthetic_v26_6_guidance_lhc}"
SYNTH_PREFIX="${2:-synthetic_v26_6_guidance_lhc}"
OUT_REL="${3:-outputs/plots/v26/v26_6_guidance_lhc_r1/regional_hist_64/umap/PAGA}"

#!/usr/bin/env bash
# BASELINE-ANCHORED CAUSAL LADDER (on-harmony T2w), rung 2 -- K-means intensity
...
# on-harmony T1w's equivalent rung. Usage: bash 04_32_train_t2w_baseline_kmeans.sh [RUN_ID]
source "$(dirname "$0")/../00_utils/env_t2w.sh"
METHOD="baseline_kmeans"
TRAINER="nnUNetTrainerOnHarmonyAugLabDefault"
DA_WORKERS=0
LOG_DIR="/tmp/nnunet_on-harmony_t2w_baseline_kmeans"

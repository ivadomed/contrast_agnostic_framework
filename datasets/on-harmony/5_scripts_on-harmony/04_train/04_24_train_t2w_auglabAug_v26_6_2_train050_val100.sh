...
# ON-Harmony T2w. Closes the matched train050 val000/val100 pair (val000 sibling:
# 04_23_train_t2w_auglabAug_v26_6_2_train050_val000.sh) for the deployed-config ladder.
# Train pipeline: full AugLab augs + V26_6_2 synth at prob 0.5.
# Val pipeline:   synth-only, V26_6_2 at prob 1.0.
# Usage: bash 04_24_train_t2w_auglabAug_v26_6_2_train050_val100.sh [RUN_ID]
source "$(dirname "$0")/../00_utils/env_t2w.sh"
METHOD="auglabAug_v26_6_2_train050_val100"
TRAINER="nnUNetTrainerOnHarmonyAugLabValSynth"
DA_WORKERS=0
LOG_DIR="/tmp/nnunet_on-harmony_t2w_auglabAug_v26_6_2_train050_val100"

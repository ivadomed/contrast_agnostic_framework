#!/usr/bin/env bash
# BASELINE-ANCHORED CAUSAL LADDER (on-harmony T2w), rung 4 -- full PALETTE partition
...
# already used by chaos's/brats2024-glioma's/on-harmony T1w's equivalent rung. This
# is the noise-fill half of the rung 4->5 causal isolation (rung 5 = v26_6_2 alone,
# IDENTICAL partition, real-intensity fill) -- the one-variable texture test.
# Usage: bash 04_34_train_t2w_baseline_kmeans_label_remap_voronoi.sh [RUN_ID]
...
DA_WORKERS=0
LOG_DIR="/tmp/nnunet_on-harmony_t2w_baseline_kmeans_label_remap_voronoi"

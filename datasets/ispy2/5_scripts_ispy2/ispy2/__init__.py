# ispy2 dataset-specific Python package (I-SPY2 breast tumour segmentation,
# primary training set as of the 2026-09-04 pivot).
# env.sh adds 5_scripts_ispy2/ to PYTHONPATH so this imports as `ispy2`:
#   from ispy2.trainers.baseline import nnUNetTrainerISPY2Baseline
# nnU-Net discovers the concrete trainer classes via the registration shim
# 02_nnunet/ISPY2Trainers.py (copied into the installed nnunetv2 package).
#
...
# fixed to 3 (see trainers/base.py) since ispy2's splits_final.json has exactly

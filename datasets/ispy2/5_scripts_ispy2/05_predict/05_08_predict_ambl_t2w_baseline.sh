...
# ambl t2w-trained baseline model. I-SPY2 has no model of its own — see
# 05_01_predict_common.sh.
# Usage: bash 05_08_predict_ambl_t2w_baseline.sh [RUN_ID] [FOLD]
set -euo pipefail
METHOD="baseline"
...
RUN_ID="${1:-ambl_t2w_baseline_20260903_003721}"

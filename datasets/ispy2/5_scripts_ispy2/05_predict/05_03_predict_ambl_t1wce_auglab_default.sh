...
# ambl t1wce-trained auglab_default model. I-SPY2 has no model of its own — see
# 05_01_predict_common.sh.
# Usage: bash 05_03_predict_ambl_t1wce_auglab_default.sh [RUN_ID] [FOLD]
set -euo pipefail
...
RUN_ID="${1:-ambl_t1wce_auglab_default_20260903_003721}"

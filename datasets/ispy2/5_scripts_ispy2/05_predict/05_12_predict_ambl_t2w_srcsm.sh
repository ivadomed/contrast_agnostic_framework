...
# ambl t2w-trained srcsm model. I-SPY2 has no model of its own — see
# 05_01_predict_common.sh.
# Usage: bash 05_12_predict_ambl_t2w_srcsm.sh [RUN_ID] [FOLD]
set -euo pipefail
METHOD="srcsm"
...
RUN_ID="${1:-ambl_t2w_srcsm_20260903_003721}"

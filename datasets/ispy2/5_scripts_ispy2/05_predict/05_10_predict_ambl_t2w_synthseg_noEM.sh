...
# ambl t2w-trained synthseg_noEM model. I-SPY2 has no model of its own — see
# 05_01_predict_common.sh.
# Usage: bash 05_10_predict_ambl_t2w_synthseg_noEM.sh [RUN_ID] [FOLD]
set -euo pipefail
...
RUN_ID="${1:-ambl_t2w_synthseg_noEM_20260903_003721}"

#!/usr/bin/env bash
# BASELINE-ANCHORED CAUSAL LADDER (ispy2 T2W), rung 4 (noise fill). See 04_18 for
# the t1wce version / full rationale. 3 folds, 1 GPU/fold, 1000 epochs.
...
DA_WORKERS=8
LOG_DIR="${RESULTS_DIR}/_logs/nnunet_ispy2_t2w_baseline_kmeans_label_remap_voronoi"

#!/usr/bin/env bash
# Train OURS (auglabAug_v26_6_2, train050, DualVal trainer) on ispy2 T1WCE — ONE
# training run producing BOTH val000 and val100 checkpoint mirrors (see
# ispy2/trainers/auglab_dualval.py). 3 folds, 1 GPU/fold, 1000 epochs.
#
...
# from it. train_common.sh's auto-generated RUN_ID already does this correctly if
# METHOD is left as below; if you pass an explicit RUN_ID, keep the "_val000_" marker.
#
# Usage:
#   bash 04_06_train_t1wce_auglabAug_v26_6_2_dualval.sh   # auto RUN_ID: ispy2_t1wce_auglabAug_v26_6_2_train050_val000_<TS>
...
DA_WORKERS=0
LOG_DIR="${RESULTS_DIR}/_logs/nnunet_ispy2_t1wce_auglabAug_v26_6_2_train050_dualval"

#!/usr/bin/env bash
# Train auglab_default (full AugLab augmentation, NO synthesis) on ispy2 T1WCE —
# the augmentation-without-synthesis reference. 3 folds, 1 GPU/fold, 1000 epochs.
#
# Usage:
#   bash 04_02_train_t1wce_auglab_default.sh                              # auto RUN_ID
#   bash 04_02_train_t1wce_auglab_default.sh ispy2_t1wce_auglab_default_<TS>   # resume
...
DA_WORKERS=8
LOG_DIR="${RESULTS_DIR}/_logs/nnunet_ispy2_t1wce_auglab_default"

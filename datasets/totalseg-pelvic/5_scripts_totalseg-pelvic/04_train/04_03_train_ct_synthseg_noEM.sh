#!/usr/bin/env bash
# Train SynthSeg-noEM (AugLab + label-free SynthSeg GPU augmentation, no EM background completion) on CT.
...
DATASET_ID="130"
DA_WORKERS=8
LOG_DIR="${RESULTS_DIR}/_logs/nnunet_totalseg_pelvic_ct_synthseg_noEM"

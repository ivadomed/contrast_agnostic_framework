#!/usr/bin/env bash
# Train OURS (auglabAug_v26_6_2, train050, DualVal trainer) on totalseg-pelvic CT — ONE run producing BOTH val000 and val100 checkpoint mirrors. RUN_ID MUST contain _val000_ exactly once.
...
DATASET_ID="130"
DA_WORKERS=0
LOG_DIR="${RESULTS_DIR}/_logs/nnunet_totalseg_pelvic_ct_auglabAug_v26_6_2_dualval"

#!/usr/bin/env bash
# CAUSAL LADDER (totalseg-pelvic CT), rung 3 — K-means + label remap, still noise fill, no Voronoi.
...
DATASET_ID="130"
DA_WORKERS=8
LOG_DIR="${RESULTS_DIR}/_logs/nnunet_totalseg_pelvic_ct_baseline_kmeans_label_remap"

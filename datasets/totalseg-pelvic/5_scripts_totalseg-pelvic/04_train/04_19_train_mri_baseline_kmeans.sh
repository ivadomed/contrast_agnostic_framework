#!/usr/bin/env bash
# CAUSAL LADDER (totalseg-pelvic MRI), rung 2 — K-means intensity clustering only. Shared, dataset-agnostic AugLab config, identical to every other dataset's rung 2.
...
DATASET_ID="131"
DA_WORKERS=8
LOG_DIR="${RESULTS_DIR}/_logs/nnunet_totalseg_pelvic_mri_baseline_kmeans"

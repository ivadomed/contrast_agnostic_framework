#!/usr/bin/env bash
# CAUSAL LADDER (totalseg-pelvic CT), rung 2 — K-means intensity clustering only. Shared, dataset-agnostic AugLab config, identical to every other dataset's rung 2.
...
DATASET_ID="130"
DA_WORKERS=8
LOG_DIR="${RESULTS_DIR}/_logs/nnunet_totalseg_pelvic_ct_baseline_kmeans"

#!/usr/bin/env bash
# Train SynthSeg-noEM (AugLab + label-free SynthSeg GPU augmentation, no EM background completion) on MRI.
...
DATASET_ID="131"
DA_WORKERS=8
LOG_DIR="${RESULTS_DIR}/_logs/nnunet_totalseg_pelvic_mri_synthseg_noEM"

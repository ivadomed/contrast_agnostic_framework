#!/usr/bin/env bash
# Train auglab_default (full AugLab augmentation, NO synthesis) on MRI — the augmentation-without-synthesis reference.
...
DATASET_ID="131"
DA_WORKERS=8
LOG_DIR="${RESULTS_DIR}/_logs/nnunet_totalseg_pelvic_mri_auglab_default"

#!/usr/bin/env bash
# Predict with the MRI-trained ladder_baseline_kmeans_label_remap model, over ct/mri.
# Usage: bash 05_21_predict_mri_ladder_baseline_kmeans_label_remap.sh <RUN_ID> [FOLD] [items...]
set -euo pipefail

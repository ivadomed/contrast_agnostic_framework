#!/usr/bin/env bash
# Predict with the MRI-trained ladder_baseline_kmeans_label_remap_voronoi model, over ct/mri.
# Usage: bash 05_22_predict_mri_ladder_baseline_kmeans_label_remap_voronoi.sh <RUN_ID> [FOLD] [items...]
set -euo pipefail

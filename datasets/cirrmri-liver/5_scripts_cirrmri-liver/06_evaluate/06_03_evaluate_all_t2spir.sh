#!/usr/bin/env bash
# Evaluate ALL 8 chaos T2spir-trained runs on CIRRMRI-LIVER T1w+T2w (folds 0-2
# parallel per run). Liver only (CIRRMRI-LIVER GT annotates liver alone).
set -euo pipefail
HERE="$(cd "$(dirname "$0")" && pwd)"

echo "=================================================================="
echo " CIRRMRI-LIVER <- CHAOS T2spir models | evaluate 8 runs x folds 0-2 | liver"
echo "=================================================================="

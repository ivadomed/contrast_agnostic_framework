#!/usr/bin/env bash
# Predict on MS3SEG with the open-ms FLAIR-TRAINED OUR METHOD model.
# Usage: bash 05_07_predict_openms_auglabAug_v26_6_2_train025_val100.sh [RUN_ID] [FOLD] [ITEM ...]
set -euo pipefail

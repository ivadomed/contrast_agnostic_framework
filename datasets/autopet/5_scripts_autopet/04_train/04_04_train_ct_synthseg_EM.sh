#!/usr/bin/env bash
# Train SynthSeg-EM (AugLab + SynthSeg-EM GPU augmentation, label-driven GMM synthesis
# with EM background completion) on autopet CT — the MAIN CONTENDER. 3 folds, 1 GPU/fold,
# 2000 epochs.
...
DATASET_ID="120"
DA_WORKERS=8
LOG_DIR="${RESULTS_DIR}/_logs/nnunet_autopet_ct_synthseg_EM"

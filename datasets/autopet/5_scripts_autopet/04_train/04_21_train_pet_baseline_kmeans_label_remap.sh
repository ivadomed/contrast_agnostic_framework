#!/usr/bin/env bash
# BASELINE-ANCHORED CAUSAL LADDER (autopet PET), rung 3 — K-means + label remap, still
# noise fill. 3 folds (0 1 2), 1 GPU/fold, 2000 epochs.
...
DATASET_ID="120"
DA_WORKERS=8
LOG_DIR="${RESULTS_DIR}/_logs/nnunet_autopet_pet_baseline_kmeans_label_remap"

#!/usr/bin/env bash
# Predict on duke-breast-mri (291 cases, t1wce only) with the ispy2 t1wce-trained srcsm model.
# See 05_01_predict_ispy2_common.sh.
# Usage: bash 05_06_predict_ispy2_t1wce_srcsm.sh [RUN_ID] [FOLD]
set -euo pipefail
METHOD="srcsm"
...
RUN_ID="${1:-ispy2_t1wce_srcsm_20260905_163655}"

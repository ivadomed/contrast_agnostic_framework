#!/usr/bin/env bash
# ============================================================================
#  PDDCA prediction — USES MODELS TRAINED ON toothfairy2 (CBCT).
#  pddca is EVALUATION-ONLY. These load toothfairy2-trained checkpoints and run
...
#  00_utils/env.sh, redirected to scratch by scripts/cluster/tamia_env_pddca.sh);
...
PREDICT_MODE="cross"
SOURCE_PREFIX="TF2"
PREDICT_JOB_PREFIX="pddca_predict"
PREDICT_LOG_PREFIX="pddca_predict"
...
# (01_02_prepare_mr.py, disabled) and follows what the PDDCA challenge teams did:
# register MR->CT and keep the ground truth in CT space.
PREDICT_ITEMS_DEFAULT="ct"   # PDDCA is CT-only; no MR arm

"""
Registration shim — makes toothfairy2 custom trainers discoverable by nnU-Net.
...
this was caught and fixed):
  cp datasets/toothfairy2/5_scripts_toothfairy2/02_nnunet/ToothFairy2Trainers.py \
...
It imports the real implementations from the `toothfairy2` package
(PROJECT_ROOT/datasets/toothfairy2/5_scripts_toothfairy2/), resolved via the NNUNET_PROJECT_ROOT
...
try:
    from toothfairy2.trainers.baseline import nnUNetTrainerToothFairy2Baseline              # noqa: F401
    from toothfairy2.trainers.auglab_default import nnUNetTrainerToothFairy2AugLabDefault    # noqa: F401
    from toothfairy2.trainers.auglab_valsynth import nnUNetTrainerToothFairy2AugLabValSynth  # noqa: F401
    from toothfairy2.trainers.auglab_dualval import nnUNetTrainerToothFairy2AugLabDualVal    # noqa: F401
except Exception as _e:  # pragma: no cover — discovery must not hard-crash nnU-Net import
    print(f"[ToothFairy2Trainers] import failed: {_e}")

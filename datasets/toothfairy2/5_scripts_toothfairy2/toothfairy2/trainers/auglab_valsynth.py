"""
nnUNetTrainerToothFairy2AugLabValSynth — AugLab trainer with synthesis-only validation.
...
from toothfairy2.trainers.auglab_default import nnUNetTrainerToothFairy2AugLabDefault


class nnUNetTrainerToothFairy2AugLabValSynth(nnUNetTrainerToothFairy2AugLabDefault):
    """AugLab for toothfairy2 with synth-only validation (val metrics on synthesised images)."""
    ...
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict,
        ...
        if not val_json:
            raise RuntimeError(
                ...
                "nnUNetTrainerToothFairy2AugLabValSynth."
            )

#!/usr/bin/env bash
# Predict on KIDNEY-T2W with the CHAOS-TRAINED T2spir auglab-default model model.
# KIDNEY-T2W has no model of its own — see 05_01_predict_common.sh.
# Usage: bash 05_13_predict_chaos_t2spir_auglab_default.sh [CHAOS_RUN_ID] [FOLD] [MODALITY ...]
set -euo pipefail

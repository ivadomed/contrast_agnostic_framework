...
def generate_grid_unified_targets(
    ...
    from src.synthesis.target_generators import V8GridTargetGenerator
...
def generate_non_monotonic_grid_targets(
    ...
    from src.synthesis.target_generators import V15GridTargetGenerator
...
def generate_micro_anchored_targets(
    ...
    from src.synthesis.target_generators import V17MicroAnchorTargetGenerator
...
def generate_unified_targets(
    ...
    from src.synthesis.target_generators import (

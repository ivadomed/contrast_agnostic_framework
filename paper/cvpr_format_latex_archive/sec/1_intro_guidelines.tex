% Author-kit submission-process guidelines originally shipped in sec/1_intro.tex
% (paper length, the ruler, paper ID, blind-review conventions, etc.).
% Kept for reference; not \input from main.tex. See sec/2_formatting.tex and
% sec/3_finalcopy.tex for the rest of the author-kit reference material.

\subsection{Submission guidelines (author-kit reference)}

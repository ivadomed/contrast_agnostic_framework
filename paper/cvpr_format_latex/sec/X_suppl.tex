...
and is significantly better in aggregate than four of the five competitors;
SRCSM is close enough (18.8mm vs.\ our 18.6mm) that the two are not
statistically distinguished ($p=0.61$). When HD95 disagrees with Dice for a
...
SynthSeg-noEM   & 78.9 &  89.9 &  7.5 & 41.9 & 54.6 & 2.9e-60 \\
SynthSeg-EM     & 17.4 &  31.8 &  4.7 & 24.7 & 19.7 & 0.0056 \\
SRCSM           & 18.3 & \textbf{26.7} &  5.6 & 24.6 & 18.8 & 0.6103 \\
Auglab          & \textbf{15.0} &  39.3 &  4.7 & 26.5 & 21.4 & 0.0012 \\
\textbf{PALETTE (ours)} & 15.2 & 30.6 & \textbf{4.2} & \textbf{24.3} & \textbf{18.6} & --- \\
\bottomrule
\end{tabular}%
}
...
\midrule
\textbf{overall} & 59.6 & \textbf{59.7} & 18.6 & \textbf{17.9} \\
\bottomrule
\end{tabular}
\caption{Applying PALETTE at validation time as well as at training time,
all four tasks. The two configurations are statistically indistinguishable
...
significant difference) despite three of four tasks favoring val100.}

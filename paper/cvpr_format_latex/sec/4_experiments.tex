...
pair; only its real-fill segment (shaded band) is coloured, by that curve's
...
(Holm-corrected across the five panels) -- a coarser, dataset-level
...
collapses. Four of five panels move significantly in the predicted
direction; ON-Harmony's panel-pooled effect is a significant

...
Across cross-contrast, cross-modality and cross-dataset transfer on six
tasks --- healthy-brain, MS-lesion, brain-tumour, abdominal-organ, mandible
and breast-lesion segmentation --- one nnU-Net configuration trained with
PALETTE attains the best Dice on four, and improves over all five competing
methods on a task-stratified test. On the other two it places second: a
statistical tie on mandible, and a real if small loss on breast, where the
texture intervention nonetheless remains among the strongest in the study.
\end{abstract}
